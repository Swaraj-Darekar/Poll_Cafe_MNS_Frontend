...
const Analytics = () => {
  ...
  const { thisMonthSales, todaysSales, totalBookings, yesterdaySales, yesterdayBookings, yesterdayCash, yesterdayOnline } = {
      ...
      <div className="analytics-grid">
        ...
        <div className="analytics-card">
          ...
          <div className="analytics-info">
            ...
            <p className="analytics-detail">{yesterdayBookings} Bookings</p>
            <div style={{ marginTop: '8px', fontSize: '0.85rem', color: '#64748b', display: 'flex', gap: '12px', background: 'rgba(0,0,0,0.03)', padding: '5px 8px', borderRadius: '4px' }}>
